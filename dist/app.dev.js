...
userSchema.plugin(passportLocalMongoose); // initializare mongoose-findorcreate

userSchema.plugin(findOrCreate); // modelu mongoose
...
app.post("/submit", function (req, res) {
  // submit text
  var submittedSecret = req.body.secret; // user 
